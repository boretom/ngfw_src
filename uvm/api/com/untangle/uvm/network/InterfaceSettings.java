...
public class InterfaceSettings implements Serializable, JSONString
{
    ...
    private String raRouterPriority; /* TODO */
    ...
    public InetAddress getRaRDNSS() { return this.raRDNSS; }
    ...
    public String getRaRouterPriority() { return this.raRouterPriority; }
    public void setRaRouterPriority( String newValue ) { this.raRouterPriority = newValue; }
